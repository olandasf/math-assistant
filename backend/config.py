...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = Field(
        default="sqlite+aiosqlite:///./database/math_teacher.db",
    ...
    # === API Keys ===
    # MathPix OCR
    MATHPIX_APP_ID: str = Field(default="", description="MathPix App ID")
    MATHPIX_APP_KEY: str = Field(default="", description="MathPix App Key")
    ...
    # === OCR nustatymai ===
    OCR_CONFIDENCE_THRESHOLD: float = Field(default=0.7, description="Minimali OCR tikimybė")
    USE_MATHPIX: bool = Field(default=True, description="Naudoti MathPix OCR")
    USE_GOOGLE_VISION: bool = Field(default=True, description="Naudoti Google Vision")
    USE_LOCAL_OCR: bool = Field(default=True, description="Naudoti lokalų Tesseract/EasyOCR")
